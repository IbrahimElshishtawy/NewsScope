...
class SportsView extends GetView<SportsController> {
  ...
  Widget build(BuildContext context) {
    return ProgramShell(
      ...
      subtitle: 'ملف رياضي بحركة محسوبة وطبقات عرض ديناميكية',
      ...
      body: Column(
        ...
        children: [
          ...
          const Custom3dSectionHeader(
            ...
            subtitle:
                'نتائج معلقة داخل بطاقات مرتفعة تمنح القسم الرياضي ديناميكية واضحة دون كسر الهوية العامة.',
          ),
          ...
          const Custom3dSectionHeader(
            ...
            title: 'لوحات الأداء',
            subtitle:
                'صناديق نتائج ثلاثية الأبعاد تمنح القسم الرياضي زخماً مرئياً متسقاً مع بقية الشاشات.',
          ),
          const SizedBox(height: 16),
          Wrap(
            spacing: 14,
