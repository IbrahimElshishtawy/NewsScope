...
class LocalNewsController extends BroadcastSectionController {
  LocalNewsController({required NewsContentRepository repository})
    : super(repository: repository, sectionKey: SectionKeys.localNews);
}
