...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      listeners: [BlocProvider(create: (context) => CategoriesCubit())],
          ...
          children: [
            ...
            BlocConsumer<GetTopHeadLineCubit, GetTopHeadLineStates>(
              ...
              builder: (context, state) {
                int key = BlocProvider.of<CategoriesCubit>(
                  context,
                ).categoryIndex;
                List<NewModel>? news = BlocProvider.of<GetTopHeadLineCubit>(
                  context,
                ).mapForNews[key];

                return Expanded(
                  child:
                      state is GetTopHeadLineLoadingStates && news == null ||
